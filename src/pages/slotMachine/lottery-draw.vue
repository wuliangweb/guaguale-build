<template>
	<view class="content">
		<view class="sm">
			<HMSlotMachine ref="Machine"></HMSlotMachine>
		</view>
...
<script>
	import HMSlotMachine from '../../component/HMSlotMachine'
	export default {
		components: {
			HMSlotMachine
		},
		data() {
			return {
				prizeList:[
					{name:'iPhone13',value:'iPhone',img:'/static/1.jpg'},
					{name:'iPhone13',value:'iPhone',img:'/static/2.jpg'},
					{name:'iPhone13',value:'iPhone',img:'/static/3.jpg'},
					{name:'iPhone13',value:'iPhone',img:'/static/4.jpg'},
					{name:'iPhone13',value:'iPhone',img:'/static/5.jpg'},
					{name:'iPhone13',value:'iPhone',img:'/static/6.jpg'},
					// {name:'iPhone13',value:'iPhone',img:'/static/1.png'},
					// {name:'airPods3',value:'airPods',img:'/static/2.png'},
					// {name:'行李箱',value:'luggage',img:'/static/3.png'},
					// {name:'风筒',value:'dryer',img:'/static/4.png'},
					// {name:'平行车',value:'balanceCar',img:'/static/5.png'},
					// {name:'iPad5',value:'iPad',img:'/static/6.png'}
				]
			}
		},
		onLoad() {
